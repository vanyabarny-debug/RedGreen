...
const Auth: React.FC = () => {
    ...
    if (savedData) {
        ...
        const newState = {
            ...
            user: {
                ...
                settings: { dailyMin: 3, dailyMax: 10 },
                friends: [],
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-rpg-bg text-rpg-text p-4">
      <div className="bg-rpg-panel p-8 rounded-lg shadow-[0_0_50px_rgba(59,130,246,0.1)] border border-rpg-border max-w-md w-full relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-rpg-secondary to-rpg-primary"></div>
        
        <div className="flex justify-center mb-6 text-rpg-secondary animate-pulse">
          <Sword size={64} />
        </div>
        <h1 className="text-4xl font-bold text-center mb-2 font-mono tracking-tighter text-rpg-text">
          LifeRPG
        </h1>
        <p className="text-center text-gray-500 mb-8 font-mono text-sm uppercase tracking-widest">System Login</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-rpg-card border border-rpg-border rounded px-4 py-3 text-rpg-text focus:border-rpg-secondary outline-none transition-colors"
          ...
          <button
            type="submit"
            className="w-full bg-rpg-secondary hover:bg-blue-600 text-white font-bold py-3 px-4 rounded transition-all duration-200 uppercase tracking-wider text-sm shadow-lg shadow-blue-900/20"
          >
            Инициализация
          </button>
