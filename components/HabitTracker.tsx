    ...
    return (
        <div className="space-y-6 pb-20">
             <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setModalOpen(true)} className="bg-white text-black px-4 py-2 rounded-lg font-bold flex items-center gap-2 hover:bg-gray-200 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {state.habits.length === 0 && (
                    <div className="col-span-full text-center py-20 border border-dashed border-rpg-border rounded-xl text-gray-500">
                ...
                {state.habits.map(habit => (
                    <div key={habit.id} className="bg-rpg-panel border border-rpg-border rounded-xl p-6 relative group hover:border-white transition-colors shadow-sm">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <button onClick={() => handleDelete(habit.id)} className="text-gray-600 hover:text-red-500 transition-colors p-2 hover:bg-white/5 rounded">
                                <Trash2 size={18}/>
                            </button>
                        </div>
            ...
            {modalOpen && (
                <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm">
                    <form onSubmit={handleCreate} className="bg-rpg-panel w-full max-w-md p-6 rounded-xl border border-rpg-border shadow-2xl animate-fade-in">
