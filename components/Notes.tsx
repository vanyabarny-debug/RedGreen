...
const Notes: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        {/* Note Detail Modal - Wrapped in Portal with HIGH Z-INDEX to fix issues */}
        {selectedNote && createPortal(
            <div className="fixed inset-0 z-[9999] bg-black/80 flex items-center justify-center p-4 backdrop-blur-sm" onClick={closeModal}>
