...
const Shop: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'style' | 'theme'>('style');
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredItems.map(item => (
              <div key={item.id} className="bg-rpg-panel border border-slate-700 p-6 rounded-2xl flex flex-col justify-between hover:border-rpg-primary transition-all">
                  <div>
